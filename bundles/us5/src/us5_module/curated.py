"""us5 curated-layer transformations: landing -> curated.
...
# Expected shape of the settlement payload landed by the shared landing bundle.
# Bumping this is a reviewable, testable change rather than a schema-inference
# surprise at 2am.
SETTLEMENT_PAYLOAD_SCHEMA = (
    "settlement_id STRING, event_ts STRING, status STRING, amount DOUBLE, currency STRING"
)
...
def conform_settlement(df):
    """Standardise landed settlement records into the curated contract.

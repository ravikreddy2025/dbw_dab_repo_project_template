"""us5 datamart-layer content.

WHAT THIS FILE IS FOR: the two things that are genuinely us5's.
...
MART_TABLES = ("dim_settlement", "fct_settlement")

# The fact table the quality gate runs against.
FACT_TABLE = "fct_settlement"

# >>> PLACEHOLDER: what "correct" means for us5. <<<

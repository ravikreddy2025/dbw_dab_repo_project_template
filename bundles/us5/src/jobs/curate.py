...
# edp_landing_nonprod.us5, not to an empty jsmith_us5. Chain your own landing
...
with audited_run(spark, ctx, layer="curated"):
    ...
    # NO overwriteSchema. The table is created and evolved by us5_migrate from
    # src/ddl/curated/settlement.sql and src/ddl/migrations/ - this job writes DATA.
    #

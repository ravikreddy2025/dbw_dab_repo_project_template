...
# MAGIC %md
# MAGIC # us5 curated quality gate
# MAGIC
...
curated = ctx.table("curated", "settlement")

# COMMAND ----------

with audited_run(spark, ctx, layer="curated"):
    # >>> PLACEHOLDER: add the us5 cross-table integrity checks here. <<<
    ...
    print(f"settlement: {total:,} rows, {undated:,} with no event timestamp")

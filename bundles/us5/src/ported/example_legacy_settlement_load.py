...
Ported from : cloudera-us5-etl @ a1b2c3d  (replace with the real origin)
...
def run_legacy_settlement_load(spark, ctx) -> int:
    ...
    target = ctx.table("curated", "settlement_legacy")

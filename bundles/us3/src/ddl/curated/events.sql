-- =============================================================================
-- us3 CURATED LAYER - table definitions
-- =============================================================================
-- >>> PLACEHOLDER <<<
--
-- THIS FILE IS EXECUTED. us3_migrate runs it on every deploy, in every
...
--
-- Written into: edp_curated_<env>.us3
-- =============================================================================

CREATE TABLE IF NOT EXISTS
  IDENTIFIER(:catalog || '.' || :schema || '.events') (
    events_id   STRING        NOT NULL COMMENT 'Natural key. Deduplicated on this.',
...
USING DELTA
COMMENT 'Curated events for us3. Written by the edp_us3 bundle.'

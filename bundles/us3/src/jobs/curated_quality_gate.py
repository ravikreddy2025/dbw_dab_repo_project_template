...
# MAGIC %md
# MAGIC # us3 curated quality gate
# MAGIC
...
curated = ctx.table("curated", "events")

# COMMAND ----------

with audited_run(spark, ctx, layer="curated"):
    # >>> PLACEHOLDER: add the us3 cross-table integrity checks here. <<<
    ...
    print(f"events: {total:,} rows, {undated:,} with no event timestamp")

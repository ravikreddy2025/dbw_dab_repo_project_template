# `ported/` — us3 lift-and-shift zone

Cloudera code for us3 lands here **near as-is** and runs as notebook or script
...
| 3. Refactored | `src/us3_module/` | wheel on the job | unit tests |
...
Sub-use-cases do **not** get their own schema — everything for us3 lands in
`edp_curated_<env>.us3`. If two sub-use-cases need separate tables, that is a

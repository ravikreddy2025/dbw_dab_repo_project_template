"""us3 datamart-layer content.

WHAT THIS FILE IS FOR: the two things that are genuinely us3's.
...
MART_TABLES = ("dim_events", "fct_events")

# The fact table the quality gate runs against.
FACT_TABLE = "fct_events"

# >>> PLACEHOLDER: what "correct" means for us3. <<<

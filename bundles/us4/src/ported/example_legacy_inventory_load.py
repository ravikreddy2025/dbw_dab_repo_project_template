...
Ported from : cloudera-us4-etl @ a1b2c3d  (replace with the real origin)
...
def run_legacy_inventory_load(spark, ctx) -> int:
    ...
    target = ctx.table("curated", "inventory_legacy")

...
# MAGIC %md
# MAGIC # us4 curated quality gate
# MAGIC
...
curated = ctx.table("curated", "inventory")

# COMMAND ----------

with audited_run(spark, ctx, layer="curated"):
    # >>> PLACEHOLDER: add the us4 cross-table integrity checks here. <<<
    ...
    print(f"inventory: {total:,} rows, {undated:,} with no event timestamp")

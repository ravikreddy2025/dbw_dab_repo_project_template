...
# edp_landing_nonprod.us2, not to an empty jsmith_us2. Chain your own landing
# output instead with `--params upstream_mode=sandbox`.
source = ctx.upstream("landing", "ora_customers")
...
with audited_run(spark, ctx, layer="curated"):
    ...
    # NO overwriteSchema. The table is created and evolved by us2_migrate from
    # src/ddl/curated/customers.sql and src/ddl/migrations/ - this job writes DATA.
    #

...
# MAGIC %md
# MAGIC # us2 curated quality gate
# MAGIC
...
curated = ctx.table("curated", "customers")

# COMMAND ----------

with audited_run(spark, ctx, layer="curated"):
    # >>> PLACEHOLDER: add the us2 cross-table integrity checks here. <<<
    ...
    print(f"customers: {total:,} rows, {undated:,} with no event timestamp")

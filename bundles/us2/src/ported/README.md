# `ported/` — us2 lift-and-shift zone

Cloudera code for us2 lands here **near as-is** and runs as notebook or script
...
| 3. Refactored | `src/us2_module/` | wheel on the job | unit tests |
...
Sub-use-cases do **not** get their own schema — everything for us2 lands in
`edp_curated_<env>.us2`. If two sub-use-cases need separate tables, that is a

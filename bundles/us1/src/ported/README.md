# `ported/` — us1 lift-and-shift zone

Cloudera code for us1 lands here **near as-is** and runs as notebook or script
...
| 3. Refactored | `src/us1_module/` | wheel on the job | unit tests |
...
`edp_curated_<env>.us1`. If two sub-use-cases need separate tables, that is a

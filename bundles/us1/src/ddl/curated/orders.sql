-- =============================================================================
-- us1 CURATED LAYER - table definitions
-- =============================================================================
-- >>> PLACEHOLDER <<<
--
...
CREATE TABLE IF NOT EXISTS
  IDENTIFIER(:catalog || '.' || :schema || '.orders') (
    orders_id   STRING        NOT NULL COMMENT 'Natural key. Deduplicated on this.',
...
USING DELTA
COMMENT 'Curated orders for us1. Written by the edp_us1 bundle.'
